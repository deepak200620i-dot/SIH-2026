...
export const Sidebar = () => {
    ...
    return (_jsxs("div", { className: "w-64 bg-gray-900 border-r border-gray-800 flex flex-col h-screen", children: [_jsx("div", { className: "flex-1 overflow-y-auto py-6", children: menuItems.map((item) => {
                ...
                }) }), _jsxs("div", { className: "p-4 border-t border-gray-800", children: [_jsx("div", { className: "text-xs font-bold text-gray-400 mb-3", children: "SYSTEM STATUS" }), _jsxs("div", { className: "space-y-2 text-xs", children: [_jsxs("div", { className: "flex items-center gap-2", children: [_jsx("div", { className: "w-2 h-2 rounded-full bg-green-500" }), _jsx("span", { className: "text-gray-300", children: "AI Engine Online" })] }), _jsxs("div", { className: "flex items-center gap-2", children: [_jsx("div", { className: "w-2 h-2 rounded-full bg-green-500" }), _jsx("span", { className: "text-gray-300", children: "Database Connected" })] }), _jsxs("div", { className: "flex items-center gap-2", children: [_jsx("div", { className: "w-2 h-2 rounded-full bg-green-500" }), _jsx("span", { className: "text-gray-300", children: "4 / 4 Cameras Online" })] })] })] })] }));
};
