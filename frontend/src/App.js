...
export const App = () => {
    ...
    return (_jsx(BrowserRouter, { children: _jsx(Routes, { children: _jsxs(Route, { element: _jsx(AppShell, { alertCount: alerts.length }), children: [_jsx(Route, { index: true, element: _jsx(Navigate, { to: "/dashboard", replace: true }) }), _jsx(Route, { path: "/dashboard", element: _jsx(Dashboard, {}) }), _jsx(Route, { path: "/live", element: _jsx(LiveSurveillance, {}) }), _jsx(Route, { path: "/cameras", element: _jsx(Cameras, {}) }), _jsx(Route, { path: "/cameras/:cameraId", element: _jsx(CameraDetails, {}) }), _jsx(Route, { path: "/alerts", element: _jsx(Alerts, {}) }), _jsx(Route, { path: "/events", element: _jsx(Events, {}) }), _jsx(Route, { path: "/face-recognition", element: _jsx(FaceRecognition, {}) }), _jsx(Route, { path: "/persons", element: _jsx(Persons, {}) }), _jsx(Route, { path: "/anpr", element: _jsx(ANPR, {}) }), _jsx(Route, { path: "/zones", element: _jsx(Zones, {}) }), _jsx(Route, { path: "/intrusions", element: _jsx(Intrusions, {}) }), _jsx(Route, { path: "/analytics", element: _jsx(Analytics, {}) }), _jsx(Route, { path: "/settings", element: _jsx(Settings, {}) }), _jsx(Route, { path: "*", element: _jsx(Navigate, { to: "/dashboard" }) })] }) }) }));
};
export default App;
